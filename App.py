...
class SignLanguageTranslator:
    ...
    def create_widgets(self):
        ...
        # Video frame
        video_frame = ttk.LabelFrame(top_frame, text="Camera Feed", padding="10")
        ...
        # Prediction frame
        pred_frame = ttk.LabelFrame(right_panel, text="Current Prediction", padding="10")
        pred_frame.pack(fill=tk.BOTH, expand=False, pady=(0, 10))
        
        self.pred_label = ttk.Label(pred_frame, text="No Prediction", font=("Arial", 28, "bold"))
        ...
        # Hand detection info
        self.hands_label = ttk.Label(pred_frame, text="Hands Detected: 0", font=("Arial", 12))
        self.hands_label.pack(pady=5)
        
        # Sentence frame
        sentence_frame = ttk.LabelFrame(right_panel, text="Formed Sentence", padding="10")
        ...
        ttk.Button(sentence_buttons, text="Add Space", command=self.add_space).pack(side=tk.LEFT, padx=5)
        ttk.Button(sentence_buttons, text="Delete Last", command=self.delete_last_word).pack(side=tk.LEFT, padx=5)
        ttk.Button(sentence_buttons, text="Clear All", command=self.clear_sentence).pack(side=tk.LEFT, padx=5)
        ...
        self.status_label = ttk.Label(status_frame, text="Status: Not Started")
        ...
        sensitivity_frame = ttk.LabelFrame(button_frame, text="Prediction Sensitivity", padding="10")
        ...
        self.start_button = ttk.Button(controls, text="Start", command=self.start_recognition)
        self.start_button.pack(side=tk.LEFT, padx=5)
        
        self.stop_button = ttk.Button(controls, text="Stop", command=self.stop_recognition, state=tk.DISABLED)
        ...
        # Add About Us button
        ttk.Button(button_frame, text="About Us", command=self.show_about_us).pack(side=tk.LEFT, padx=20)
    ...
    def show_about_us(self):
        ...
        # Title
        title_label = ttk.Label(main_frame, text="Our Team", font=("Arial", 18, "bold"))
        ...
        description.insert(tk.END, "Sign Language Translator Project\n\n"
